...
const shows = [
  {
    ...
    shows: [
      {name:'Alangu',image:'https://assets-in.bmscdn.com/discovery-catalog/events/et00423853-zxtespsxdv-landscape.jpg',link:'https://dls4.mrfooll.xyz/AgAD-x3209304?open_in_chrome=true'},
